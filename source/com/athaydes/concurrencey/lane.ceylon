...
"A Lane represents a Thread where [[com.athaydes.concurrencey::Action]]s may run. A Lane is not exactly the
...
shared class Lane(
	...
	"Indicates whether this Lane is currently busy. Notice that even if this method returns
	 ...
	 is no guarantee the Lane will actually be free by the time an [[com.athaydes.concurrencey::Action]] is submitted to
	 run on it."
